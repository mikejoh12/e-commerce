...
const { fetchUsersDb, fetchUserByIdDb, fetchUserByEmailDb, fetchUserByFacebookIdDb, createUserDb, modifyUserDb, removeUserDb } = require('./users.db')
...
module.exports = {
  ...
  fetchUsersDb, fetchUserByIdDb, fetchUserByEmailDb, fetchUserByFacebookIdDb, createUserDb, modifyUserDb, removeUserDb,
